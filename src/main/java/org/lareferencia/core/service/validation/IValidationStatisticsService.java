...
public interface IValidationStatisticsService {
    ...
    ValidationStatsObservationsResult queryValidationStatsObservationsBySnapshotID(
            Long snapshotID,
            List<String> filters,
            Pageable pageable) throws ValidationStatisticsException;
    ...
    ValidationStatsResult queryValidatorRulesStatsBySnapshot(
            ...
            List<String> filters) throws ValidationStatisticsException;
     ...
     * @throws ValidationStatisticsException If an error occurs during the query
     */
    ValidationRuleOccurrencesCount queryValidRuleOccurrencesCountBySnapshotID(Long snapshotID, Long ruleID,
            List<String> fq) throws ValidationStatisticsException;
     ...
     * @throws ValidationStatisticsException If an error occurs during
     *                                       initialization
     */
    ...
    RecordValidation getRecordValidationListBySnapshotAndIdentifier(Long snapshotID, String identifier)
