...
/**
 * Worker that performs OAI-PMH harvesting operations (LEGACY - SQL Storage).
 * <p>
 * Handles the complete harvesting workflow including metadata fetching,
 * validation, and storage using SQL database for records.
 * </p>
 * 
 * @deprecated Use HarvestingWorker (Parquet-based) instead
 * @author LA Referencia Team
 */
@Deprecated
public class HarvestingWorkerLegacy extends BaseWorker<NetworkRunningContext> implements IWorker<NetworkRunningContext>, IHarvestingEventListener {

	private static final String DEFAULT_GRANDULARITY = "YYYY-MM-DDThh:mm:ssZ";

	private static Logger logger = LogManager.getLogger(HarvestingWorkerLegacy.class);
	 ...
	 */
	public HarvestingWorkerLegacy(Network network) {
