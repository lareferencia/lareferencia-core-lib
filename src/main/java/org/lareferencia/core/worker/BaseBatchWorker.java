...
public abstract class BaseBatchWorker<I, C extends IRunningContext> extends BaseWorker<C>
	...
	/**
	 * Default live status for paginated workers. Concrete workers can add
	 * domain-specific counters, but every batch worker reports its page-level
	 * progress even when it has no custom implementation.
	 */
	@Override
